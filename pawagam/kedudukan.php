                    ...
                    <div class="kedudukan" style="width:100%">
                        <div class="container" style="width:100%;text-align:center;">
                            <div class="row desc" style="width:100%;text-align:center;display:block;">
                                ...
                                <h4><?php echo $namaWayang . "<span> | </span>" . $tempohWayang . "minit" . "<span> | </span>" . $tarikh[1] . "<span> | </span>" . $masa . "<span> | </span>" . "Bilik" . " " . $dataBilik[0]['idBilik']; ?></h4> 
                            </div>
                        </div>
                        <form action="pilihanTiket.php" method="POST">
                            ...
                            <?php
                                ...
                                echo $namaWayang . "<span> | </span>" . $tempohWayang . "minit" . "<span> | </span>" . $tarikh[1] . "<span> | </span>" . $masa . "<span> | </span>" . "Bilik" . " " . $dataBilik[0]['idBilik'];
                                echo '">';
                                ...
                                } elseif ($dataBilik[0]['saizBilik'] == 112) {
                                    $rowLetter = array("H", "G", "F", "E", "D", "C", "B", "A");
                                    for ($baris = 0; $baris < count($rowLetter); $baris ++) {
                                        echo '<tr>';
                                        for ($seat = 1; $seat < 15; $seat ++) {
                                            $seatID = $rowLetter[$baris] . sprintf('%02d', $seat);
